...
(async()=>{
 ...
 const section=ctx.zeusRetentionSection(retentionSettings);assert.match(section,/PORCEIMPUESTO/);assert.match(section,/readonly/);assert.doesNotMatch(section,/Todas las tarifas/);
