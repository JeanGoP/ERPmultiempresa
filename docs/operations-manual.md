...
La prueba restaura con otro nombre, ejecuta `DBCC CHECKDB`, valida al menos 41 migraciones y elimina solamente la base temporal. Registrar duración como RTO observado.
