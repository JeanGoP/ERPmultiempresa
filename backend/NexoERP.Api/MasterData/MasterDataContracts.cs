...
public sealed record SupplierResponse(long TerceroId,string TipoIdentificacion,string NumeroIdentificacion,string? DigitoVerificacion,string RazonSocial,bool Activo);
...
public sealed record SaveSupplierRequest(string TipoIdentificacion,string NumeroIdentificacion,string? DigitoVerificacion,string RazonSocial,long? UsuarioId);
