...
public sealed record LoginResponse(string Token,DateTime ExpiraEnUtc,long UsuarioId,string NombreCompleto,bool EsSuperAdministrador,long? EmpresaId);
...
public sealed record CreateCompanyRequest(string Codigo,string Nit,string? DigitoVerificacion,string RazonSocial,string MonedaFuncional,string? ZonaHoraria,string? MarcoContable,NexoERP.Api.Zeus.ZeusConnectionInput? Zeus=null);
